...
use Iglesys\Bundle\GeneralBundle\Form\PaisType;
...
class PaisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IglesysGeneralBundle:Pais')->findAll();

        return $this->render('IglesysGeneralBundle:Pais:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('IglesysGeneralBundle:Pais:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IglesysGeneralBundle:Pais')->find($id);
        ...
        return $this->render('IglesysGeneralBundle:Pais:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('IglesysGeneralBundle:Pais:edit.html.twig', array(
            'entity'      => $entity,
